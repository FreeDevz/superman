 ...
 *
 * <p>
 * Simulates the classic Snake game on a {@code height x width} board with predefined food
 * locations. The snake grows when eating food, and the game ends when the snake either hits the
 * border or collides with itself.
 *
 * <p>
 * <strong>Constraints</strong>
 * <ul>
 * <li>{@code 1 <= width, height <= 10^4}
 * <li>{@code 1 <= food.length <= 50}
 * <li>At most {@code 10^4} calls to {@code move}
 * </ul>
 *
 * <p>
 * This file provides two implementations with different internal data structures, along with
 * reusable validation helpers:
 *
 * <ol>
 * <li>{@link SnakeGameDeque}: Uses a deque with a hash set for {@code O(1)} body updates.
 * <li>{@link SnakeGameLinkedList}: Uses a custom doubly linked list to more closely mimic the
 * traditional snake representation.
 * </ol>
 */
